            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <br><a href="create.php" class="btn btn-success pull-right">Agregar nueva noticia</a></div>
                    </div>
                    <?php
                    // Include config file
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='read.php?id=". $row['id'] ."' title='Ver noticia' data-toggle='tooltip'><span class='glyphicon glyphicon-zoom-in'></span></a>";
